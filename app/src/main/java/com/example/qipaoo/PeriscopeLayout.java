...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        Drawable red = getResources().getDrawable(R.drawable.ic_insert_emoticon_red_200_24dp);
        Drawable yellow = getResources().getDrawable(R.drawable.ic_insert_emoticon_deep_purple_a100_24dp);
        Drawable blue = getResources().getDrawable(R.drawable.ic_insert_emoticon_blue_300_24dp);
    ...
    private ValueAnimator getBezierValueAnimator(View target) {
        ...
        ValueAnimator animator = ValueAnimator.ofObject(evaluator, new PointF((mWidth - dWidth) , mHeight - dHeight), new PointF(random.nextInt(getWidth()), 0));
